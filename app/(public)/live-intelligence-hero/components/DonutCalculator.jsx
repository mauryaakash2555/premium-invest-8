...
/**
 * DonutCalculator - Collapsible Calculator (DONUT IS OUTSIDE - IN PAGE.JSX)
 * 
 * This component is ONLY the calculator dropdown.
 * The donut chart with all animations stays in the main page.
 */
...
export default function DonutCalculator() {
  ...
  return (
    <div className="calc-wrap">
      ...
      {/* Collapsible Calculator Content */}
      {isOpen && (
