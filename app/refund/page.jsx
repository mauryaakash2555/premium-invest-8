        ...
        <div style={{ maxWidth: '900px', margin: '0 auto', padding: '0 20px' }}>
          ...
          <div>
            ...
            <section style={{ marginBottom: '40px' }}>
              ...
              <ul style={{ listStyleType: 'disc', paddingLeft: '24px', marginBottom: '20px', color: '#B8B8B8' }}>
                <li style={{ fontSize: '16px', lineHeight: '1.8', marginBottom: '12px' }}>â‚¹100 per subscription of â‚¹10,000 and above (for new investors)</li>
                <li style={{ fontSize: '16px', lineHeight: '1.8', marginBottom: 0 }}>â‚¹150 per subscription of â‚¹10,000 and above (for existing investors)</li>
              </ul>
              <p style={{ fontSize: '16px', color: '#B8B8B8', lineHeight: '1.8', margin: 0 }}>
