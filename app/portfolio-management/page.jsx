    ...
    <div style={{ backgroundColor: '#000000', minHeight: '100vh', color: '#ffffff' }}>
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '60px 20px' }}>
        ...
        <section style={{ marginBottom: '60px' }}>
          ...
          <p style={{ fontSize: '17px', lineHeight: '1.8', color: '#e5e5e5', marginBottom: '20px', textAlign: 'justify' }}>
            Our portfolio construction process follows a systematic, repeatable methodology ensuring consistency and objectivity. The journey begins with comprehensive financial planning â€“ understanding your complete financial picture including income, expenses, assets, liabilities, insurance coverage, and existing investments. For Mumbai clients, this often involves evaluating substantial real estate holdings, family business interests, or offshore investments alongside traditional financial assets.
          </p>
          <p style={{ fontSize: '17px', lineHeight: '1.8', color: '#e5e5e5', marginBottom: '20px', textAlign: 'justify' }}>
            Goal identification forms the cornerstone of portfolio design. We work with clients to articulate and prioritize financial objectives: retirement planning (typical Mumbai retirement corpus requirements range from â‚¹5-20 crores depending on lifestyle expectations), children's education (international education costs now exceed â‚¹1 crore per child), wedding expenses, home purchases, philanthropy, wealth transfer, or simply wealth accumulation. Each goal is assigned a timeframe, target amount, and priority level, forming the foundation for asset allocation decisions.
          </p>
          <p style={{ fontSize: '17px', lineHeight: '1.8', color: '#e5e5e5', marginBottom: '20px', textAlign: 'justify' }}>
          ...
          <p style={{ fontSize: '17px', lineHeight: '1.8', color: '#e5e5e5', marginBottom: '20px', textAlign: 'justify' }}>
            Asset allocation â€“ determining the mix of equities, debt, gold, real estate, and alternative investments â€“ is perhaps the most critical portfolio decision, explaining 80-90% of portfolio returns according to academic research. Our allocations are science-based, using mean-variance optimization, Monte Carlo simulations, and historical return analysis while incorporating forward-looking market views. A typical balanced portfolio for a 40-year-old Mumbai professional might comprise 60% equity (diversified across large, mid, and small caps, domestic and international), 30% debt (mix of duration and credit strategies), 5% gold (inflation hedge and portfolio stabilizer), and 5% alternatives or cash. This allocation is customized based on individual circumstances.
          </p>
        </section>
        ...
        <section style={{ marginBottom: '60px' }}>
          ...
          <p style={{ fontSize: '17px', lineHeight: '1.8', color: '#e5e5e5', marginBottom: '20px', textAlign: 'justify' }}>
            Asset allocation evolves throughout your investment lifecycle, adapting to changing circumstances, goals, and market conditions. Our dynamic allocation strategies balance several competing objectives: growth vs. stability, income vs. capital appreciation, liquidity vs. illiquidity premium, tax efficiency vs. gross returns, and domestic vs. international exposure. For young Mumbai professionals (25-35 years), we typically recommend aggressive allocations with 80-90% equity exposure, capitalizing on long investment horizons and human capital. These portfolios emphasize growth-oriented assets â€“ equity mutual funds, direct equity positions, international equity exposure, and potentially early-stage investments or ESOPs.
          </p>
          <p style={{ fontSize: '17px', lineHeight: '1.8', color: '#e5e5e5', marginBottom: '20px', textAlign: 'justify' }}>
            Mid-career professionals (35-50 years) often have multiple competing goals â€“ children's education approaching, retirement planning beginning, potential home upgrades, elderly parent care. Their portfolios transition toward balanced allocations with 60-70% equity, incorporating more stable debt instruments for near-term goals while maintaining equity exposure for long-term objectives. This life stage often sees the highest savings rates for Mumbai professionals, making systematic investment particularly powerful. Senior professionals and pre-retirees (50-60 years) require careful portfolio transitioning. We implement "glide path" strategies gradually reducing equity exposure as retirement approaches, typically moving from 60% equity at 50 years to 30-40% at retirement. This de-risking preserves accumulated wealth while maintaining inflation protection through meaningful equity allocation.
          </p>
          <p style={{ fontSize: '17px', lineHeight: '1.8', color: '#e5e5e5', marginBottom: '20px', textAlign: 'justify' }}>
            Retirees need income-focused portfolios balancing capital preservation with inflation protection. Our retiree portfolios typically allocate 30-40% to equity (providing growth and dividend income), 50-60% to debt (generating regular interest income), and 10% to gold/alternatives (portfolio stability). We construct laddered debt portfolios ensuring steady monthly income while managing interest rate risk. Systematic withdrawal plans (SWPs) from mutual funds provide tax-efficient income streams for Mumbai retirees, often superior to traditional pension plans or annuities. High net worth individuals with substantial corpus (â‚¹5 crores+) can afford more sophisticated strategies including Portfolio Management Services (PMS), Alternative Investment Funds (AIFs), direct equity portfolios, offshore investing, and structured products. We provide referrals to SEBI-registered PMS providers and AIFs aligned with your risk profile and investment philosophy.
          </p>
        </section>
        ...
        <section style={{ marginBottom: '60px' }}>
          ...
          <p style={{ fontSize: '17px', lineHeight: '1.8', color: '#e5e5e5', marginBottom: '20px', textAlign: 'justify' }}>
            For Mumbai millennials and Gen Z facing astronomical real estate costs, we advocate building substantial financial asset portfolios first before considering property purchases. A 30-year-old earning â‚¹15 lakhs annually might face â‚¹2 crore+ costs for a decent 2BHK apartment in suburbs. Rather than straining finances with massive EMIs, systematic investing of â‚¹30,000-40,000 monthly over 10-15 years builds significant corpus while maintaining financial flexibility. Once substantial financial assets are accumulated, property purchases can complement rather than dominate portfolios. Many successful Mumbai investors built financial portfolios first, using market appreciation and dividend income to fund property purchases without devastating their overall financial health. This sequencing â€“ financial assets first, real estate strategically later â€“ creates balanced, resilient portfolios for long-term wealth creation.
          </p>
        </section>
