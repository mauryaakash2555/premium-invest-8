                ...
                >
                  <a 
                    ...
                    style={{
                      ...
                      gap: '10px',
                      padding: '12px 18px',
                      background: 'linear-gradient(135deg, rgba(37, 211, 102, 0.16) 0%, rgba(218, 165, 32, 0.06) 100%)',
                      color: '#E8E8E8',
                    ...
                    onMouseEnter={(e) => {
                      e.currentTarget.style.background = 'linear-gradient(135deg, rgba(37, 211, 102, 0.22) 0%, rgba(218, 165, 32, 0.10) 100%)';
                      e.currentTarget.style.transform = 'translateY(-2px)';
                      e.currentTarget.style.borderColor = 'rgba(37, 211, 102, 0.55)';
                      e.currentTarget.style.color = '#FFFFFF';
                    }}
                    onMouseLeave={(e) => {
                      e.currentTarget.style.background = 'linear-gradient(135deg, rgba(37, 211, 102, 0.16) 0%, rgba(218, 165, 32, 0.06) 100%)';
