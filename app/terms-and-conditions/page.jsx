...
const TermsAndConditions = () => {
  ...
  const pageUrl = `${baseUrl}/terms-and-conditions`;
  const pageSchema = {
  ...
  return (
    <>
      ...
      <div style={{ minHeight: '100vh', background: '#000000', paddingTop: '120px', paddingBottom: '80px' }}>
        ...
        <script
          id="terms-and-conditions-webpage-schema"
        ...
        <div style={{ maxWidth: '900px', margin: '0 auto', padding: '0 20px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '18px' }}>
            ...
            />
            <div>
              <p style={{ margin: 0, fontSize: '13px', color: '#999', letterSpacing: '0.02em' }}>
                BM Wealth • Legal
              </p>
              <p style={{ margin: 0, fontSize: '13px', color: '#999' }}>
                Related: <Link href="/privacy" style={{ color: 'inherit', textDecoration: 'underline' }}>Privacy</Link> •{' '}
                <Link href="/disclaimer" style={{ color: 'inherit', textDecoration: 'underline' }}>Disclaimer</Link> •{' '}
          ...
          <div className="bp-body">
            ...
            <section style={{ marginTop: '46px' }}>
              ...
              <p style={{ fontSize: '16px', color: '#B8B8B8', lineHeight: '1.8', margin: 0 }}>
                <Link href="/about-us" style={{ color: 'inherit', textDecoration: 'underline' }}>About Us</Link> •{' '}
                <Link href="/services" style={{ color: 'inherit', textDecoration: 'underline' }}>Services</Link> •{' '}
                <Link href="/fixed-deposits" style={{ color: 'inherit', textDecoration: 'underline' }}>Fixed Deposits</Link> •{' '}
                <Link href="/tools/itr-filing-help" style={{ color: 'inherit', textDecoration: 'underline' }}>ITR Filing Help Tool</Link>
              </p>
            </section>
          </div>
        </div>
