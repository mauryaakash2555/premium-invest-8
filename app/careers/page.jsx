      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '60px 20px' }}>
        ...
        <section style={{ marginBottom: '60px' }}>
          ...
          <div style={{ marginBottom: '40px', padding: '30px', background: 'rgba(218, 165, 32, 0.1)', borderRadius: '8px', border: '1px solid rgba(192, 160, 98, 0.5)' }}>
            ...
            <p style={{ fontSize: '17px', lineHeight: '1.8', color: '#e5e5e5', marginBottom: '16px' }}>
              <strong>Compensation:</strong> Fixed salary (â‚¹XX lakhs annually depending on experience) plus performance-based incentives (can exceed fixed salary for top performers). Total compensation range: â‚¹XX lakhs annually.
            </p>
          </div>
          ...
          <div style={{ marginBottom: '40px', padding: '30px', background: 'rgba(218, 165, 32, 0.1)', borderRadius: '8px', border: '1px solid rgba(192, 160, 98, 0.5)' }}>
            ...
            <p style={{ fontSize: '17px', lineHeight: '1.8', color: '#e5e5e5', marginBottom: '16px' }}>
              <strong>Compensation:</strong> â‚¹XX lakhs annually plus performance bonuses. Total compensation: â‚¹XX lakhs annually.
            </p>
          </div>
          ...
          <div style={{ marginBottom: '40px', padding: '30px', background: 'rgba(218, 165, 32, 0.1)', borderRadius: '8px', border: '1px solid rgba(192, 160, 98, 0.5)' }}>
            ...
            <p style={{ fontSize: '17px', lineHeight: '1.8', color: '#e5e5e5', marginBottom: '16px' }}>
              <strong>Compensation:</strong> â‚¹XX lakhs fixed plus significant commission potential. Total compensation: â‚¹XX lakhs annually based on business generated.
            </p>
          </div>
        </section>
        ...
        <section style={{ marginBottom: '60px' }}>
          ...
          <p style={{ fontSize: '17px', lineHeight: '1.8', color: '#e5e5e5', marginBottom: '20px', textAlign: 'justify' }}>
            We offer competitive benefits package including health insurance coverage for employees and dependents, performance-based annual bonuses, paid time off (casual leave, sick leave, annual leave), flexible working arrangements (work from home options post-probation), professional development budget for certifications and training, recognition and rewards for outstanding performance, and team outings and celebrations fostering camaraderie. Our culture emphasizes integrity above all â€“ we never compromise ethics for short-term gains. Client-centricity guides every decision; we succeed when clients succeed. Collaboration over competition â€“ team members support each other rather than competing internally. We maintain work-life balance recognizing that burned-out advisors can't serve clients well. We celebrate diversity welcoming team members from different backgrounds, experiences, and perspectives. We operate transparently with open communication between leadership and team members. Mumbai's vibrant culture enhances our work experience â€“ team lunches at local restaurants, occasional evening gatherings at cafes or lounges, celebration of festivals reflecting Mumbai's diversity, and participation in city's financial community events.
          </p>
        </section>
