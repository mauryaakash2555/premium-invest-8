    ...
    <div style={{ backgroundColor: '#000000', minHeight: '100vh', color: '#ffffff' }}>
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '60px 20px' }}>
        ...
        <section style={{ marginBottom: '60px' }}>
          ...
          <p style={{ fontSize: '17px', lineHeight: '1.8', color: '#e5e5e5', marginBottom: '20px', textAlign: 'justify' }}>
            Risk management separates successful traders from the majority who lose money. The fundamental rule: never risk more than you can afford to lose. We recommend Mumbai traders follow these critical risk principles: Position sizing limits individual position risk to 2-5% of trading capital maximum. If you have â‚¹5 lakh trading capital, no single position should risk more than â‚¹10,000-25,000. This ensures even a string of losses doesn't devastate your account, keeping you in the game long enough to benefit from winning trades. Stop losses are mandatory for every trade â€“ predefined prices where you'll exit losing positions regardless of hope or emotion. A typical swing trade might use 5-7% stop loss, meaning if stock declines 5-7% from entry, you exit automatically. This disciplines you to cut losses quickly rather than holding and hoping as losses balloon. Risk-reward ratios should favor reward â€“ aim for at least 1:2 or 1:3 risk-reward, meaning if you risk â‚¹10,000 on a trade, target at least â‚¹20,000-30,000 profit. This mathematics means you can be right only 40-50% of the time yet still profit overall.
          </p>
          <p style={{ fontSize: '17px', lineHeight: '1.8', color: '#e5e5e5', marginBottom: '20px', textAlign: 'justify' }}>
            Leverage management is critical â€“ using margin or derivatives multiplies both gains and losses. A 2x leveraged position in a stock declining 10% creates 20% account loss. Many traders blown up weren't wrong on market direction but used excessive leverage turning small moves into catastrophic losses. Our recommendation: use minimal leverage until you've proven consistent profitability for 12+ months, and even then, never exceed 2x leverage. Diversification applies to trading too â€“ don't concentrate positions in single sector or correlated stocks. If you hold 5 positions all in banking or real estate, sector-specific bad news hits all positions simultaneously. Spread positions across 4-6 uncorrelated sectors. Emotional control might be most important â€“ fear and greed destroy more trading accounts than lack of knowledge. Trading triggers powerful emotions; winning streaks create overconfidence leading to excessive risk-taking, while losing streaks create fear paralyzing decision-making or revenge trading trying to recover losses quickly. Maintaining trading journal documenting every trade â€“ entry reason, exit reason, emotions felt, lessons learned â€“ builds self-awareness and discipline over time.
          </p>
        </section>
