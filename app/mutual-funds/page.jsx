      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '60px 20px' }}>
        ...
        <section style={{ marginBottom: '60px' }}>
          ...
          <div style={{
            ...
            {[
              ...
              { icon: <Calculator size={32} />, title: 'Flexible SIPs', desc: 'Start with just â‚¹500 per month' }
            ].map((item, idx) => (
              <div key={idx} style={{
        ...
        <section style={{ marginBottom: '60px' }}>
          ...
          <div style={{ marginBottom: '40px' }}>
            ...
            <p style={{ fontSize: '17px', lineHeight: '1.8', color: '#e5e5e5', marginBottom: '16px', textAlign: 'justify' }}>
              Equity Linked Savings Schemes (ELSS) are the most popular tax-saving investment option under Section 80C of the Income Tax Act. With a short 3-year lock-in period (shortest among 80C options), ELSS funds offer dual benefits: tax deduction up to â‚¹1.5 lakh annually and wealth creation through equity market exposure. For Mumbai's salaried professionals in higher tax brackets, ELSS is a no-brainer investment that combines tax efficiency with growth potential. Our recommended ELSS funds have delivered 12-14% returns over 5-year periods while providing tax savings of up to â‚¹46,800 (at 31.2% tax rate including cess).
            </p>
          </div>
        ...
        <section style={{ marginBottom: '60px' }}>
          ...
          <p style={{ fontSize: '17px', lineHeight: '1.8', color: '#e5e5e5', marginBottom: '20px', textAlign: 'justify' }}>
            <strong style={{ color: '#C0A062' }}>Systematic Investment Plan (SIP):</strong> SIPs embody the principle of disciplined investing. By investing a fixed amount monthly (say â‚¹5,000 or â‚¹10,000), you automatically buy more units when markets are low and fewer units when markets are high â€“ a phenomenon called rupee cost averaging. For salaried professionals in Mumbai, SIPs align perfectly with monthly income flows, making investing effortless and removing the stress of market timing. Our data shows that investors who started â‚¹10,000 monthly SIPs in large cap funds 10 years ago have accumulated corpus values of â‚¹22-25 lakhs, demonstrating the power of disciplined long-term investing.
          </p>
          <p style={{ fontSize: '17px', lineHeight: '1.8', color: '#e5e5e5', marginBottom: '20px', textAlign: 'justify' }}>
            <strong style={{ color: '#C0A062' }}>Lump Sum Investing:</strong> If you've received a windfall â€“ annual bonus, property sale proceeds, inheritance, or maturity of fixed deposits â€“ lump sum investing might be appropriate. Historical data shows that lump sum investments outperform SIPs about 65-70% of the time over long periods, simply because markets trend upward over time. However, lump sum investing requires strong conviction and the ability to withstand short-term volatility. For Mumbai investors sitting on surplus cash, we often recommend a hybrid approach: invest 30-40% immediately as lump sum and set up SIPs for the remaining amount over 6-12 months (called Systematic Transfer Plan or STP).
          </p>
          <p style={{ fontSize: '17px', lineHeight: '1.8', color: '#e5e5e5', marginBottom: '20px', textAlign: 'justify' }}>
        ...
        <section style={{ marginBottom: '60px' }}>
          ...
          <div style={{ marginBottom: '24px' }}>
            ...
            <p style={{ fontSize: '17px', lineHeight: '1.8', color: '#e5e5e5', marginBottom: '16px', textAlign: 'justify' }}>
              We begin with an in-depth consultation to understand your financial objectives â€“ retirement planning, child's education, home purchase, wealth creation, or tax saving. We assess your current financial situation, income stability, existing investments, liabilities, and family responsibilities. For Mumbai clients, we also consider city-specific factors like high living costs, real estate investments, and inflation trends.
            </p>
          </div>
          ...
          <div style={{ marginBottom: '24px' }}>
            ...
            <p style={{ fontSize: '17px', lineHeight: '1.8', color: '#e5e5e5', marginBottom: '16px', textAlign: 'justify' }}>
              We facilitate seamless investment through multiple channels â€“ direct bank transfers, online payment gateways, or physical checks. For SIPs, we set up auto-debit mandates ensuring hassle-free monthly investments. You receive instant confirmation and digital account statements for all transactions. Our Mumbai clients appreciate our personalized service, whether investing â‚¹500 or â‚¹5 lakhs.
            </p>
          </div>
        ...
        <section style={{ marginBottom: '60px' }}>
          ...
          <p style={{ fontSize: '17px', lineHeight: '1.8', color: '#e5e5e5', marginBottom: '20px', textAlign: 'justify' }}>
            <strong style={{ color: '#C0A062' }}>Equity Mutual Funds Taxation:</strong> Long-term capital gains (LTCG) above â‚¹1 lakh per year from equity funds held beyond 12 months are taxed at 10% without indexation. Short-term gains (sold within 12 months) attract 15% tax. This favorable taxation makes equity funds more tax-efficient than fixed deposits where interest is fully taxable at your income tax slab rate. For instance, a â‚¹10 lakh equity investment growing to â‚¹15 lakhs over 3 years results in minimal tax liability of â‚¹40,000 (10% on â‚¹4 lakhs after â‚¹1 lakh exemption), versus â‚¹1.5 lakhs+ on equivalent FD returns.
          </p>
          <p style={{ fontSize: '17px', lineHeight: '1.8', color: '#e5e5e5', marginBottom: '20px', textAlign: 'justify' }}>
          ...
          <p style={{ fontSize: '17px', lineHeight: '1.8', color: '#e5e5e5', marginBottom: '20px', textAlign: 'justify' }}>
            <strong style={{ color: '#C0A062' }}>ELSS Tax Deductions:</strong> ELSS investments qualify for deduction under Section 80C up to â‚¹1.5 lakh annually, providing immediate tax savings of â‚¹46,800 for those in the 30% bracket (plus cess). Combined with growth potential, ELSS offers unmatched tax-saving benefits compared to other 80C options like PPF or NSC.
          </p>
        </section>
          ...
          {[
            {
              ...
              a: 'Most mutual funds allow SIPs starting at just â‚¹500 per month, though we typically recommend starting with at least â‚¹2,000-3,000 monthly to see meaningful wealth creation. There is no maximum limit â€“ our Mumbai clients invest anywhere from â‚¹5,000 to â‚¹2 lakhs monthly through SIPs.'
            },
            {
              q: 'How are mutual funds taxed in India?',
              a: 'Equity funds: Long-term gains (>12 months) above â‚¹1 lakh taxed at 10%, short-term at 15%. Debt funds: Taxed per your income slab. ELSS offers 80C deduction up to â‚¹1.5 lakh. We provide detailed tax planning guidance during portfolio construction.'
            },
            {
