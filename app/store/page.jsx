    ...
    <div className="space-y-10">
      <section className="space-y-4">
        ...
        <p className="max-w-2xl text-sm leading-relaxed text-white/70">
          This store sells only digital educational content (PDFs/tools). Digital delivery only.
        </p>
        <div className="flex gap-3">
          <Link
            href="/products"
            className="inline-flex items-center rounded-none border border-white/15 bg-white/5 px-5 py-3 text-sm text-white hover:bg-white/10"
          >
            View products
          </Link>
          <Link
            href="/delivery"
            className="inline-flex items-center rounded-none border border-white/15 px-5 py-3 text-sm text-white/80 hover:text-white"
          >
            Delivery policy
          </Link>
        </div>
