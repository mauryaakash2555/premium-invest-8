            ...
            <>
              ...
              <section style={{ marginBottom: '56px' }}>
                ...
                <p style={{ fontSize: '17px', lineHeight: '1.85', color: '#e5e5e5', margin: '0 0 18px 0' }}>
                  Laddering means splitting money across multiple FDs with different maturities (instead of one long FD).
                  This can improve flexibility because part of your money matures regularly.
                </p>
