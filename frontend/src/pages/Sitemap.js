  ...
  return (
    <div style={{ backgroundColor: '#000000', minHeight: '100vh', color: '#ffffff' }}>
      <Helmet>
        ...
        <link rel="canonical" href="https://bmwealth.co.in/sitemap" />
        
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://bmwealth.co.in/sitemap" />
        ...
        <meta name="twitter:url" content="https://bmwealth.co.in/sitemap" />
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '60px 20px' }}>
        ...
        {/* Contact Section */}
        <section style={{ marginTop: '80px', padding: '40px', background: 'color-mix(in oklab, var(--lux-accent) 10%, transparent)', borderRadius: '12px', border: '1px solid color-mix(in oklab, var(--lux-accent) 50%, transparent)' }}>
