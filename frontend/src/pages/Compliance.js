  ...
  return (
    <div>
      <Helmet>
        ...
        <meta
          name="description"
          content="BM Wealth regulatory compliance, investor charter, grievance redressal mechanism. IRDAI Licensed and AMFI Registered ARN 90008. Transparent and regulated financial advisory in Mumbai."
        />
        <meta
          name="keywords"
          content="regulatory compliance, investor charter, ARN 90008, IRDAI licensed, AMFI registered, investment advisor compliance, grievance redressal, investor protection"
        />
        ...
        <meta
          property="og:title"
          content="Regulatory Compliance & Investor Charter | BM Wealth ARN 90008"
        />
        <meta
          property="og:description"
          content="Regulatory compliance, investor charter, and grievance redressal. IRDAI Licensed and AMFI Registered ARN 90008."
        />
        ...
        <meta
          name="twitter:title"
          content="Regulatory Compliance & Investor Charter | BM Wealth"
        />
        <meta
      ...
      <section className="page-hero-section">
        <div
          ...
          style={{
            backgroundImage:
              'url(https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=1920&h=1080&fit=crop&auto=format&fm=webp&q=80)',
          }}
        />
        <div
          style={{
        ...
        >
          ...
          >
            Committed to transparency, investor protection, and regulatory compliance with IRDAI
            and AMFI
          </p>
        </div>
      </section>
      ...
      <section className="section-container">
        <div className="glass-effect" style={{ padding: '60px 40px', marginBottom: '40px' }}>
          ...
          <div style={{ color: '#CCCCCC', lineHeight: 1.8, fontSize: '16px' }}>
            ...
            <p style={{ marginBottom: '20px' }}>
              BM Wealth is committed to providing professional investment advisory services with
              the highest standards of integrity, transparency, and investor protection in
              accordance with IRDAI and AMFI regulations.
            </p>
            ...
            <ul style={{ paddingLeft: '20px', marginBottom: '20px' }}>
              <li style={{ marginBottom: '12px' }}>
                <strong>Right to Fair Treatment:</strong> Equal and fair treatment without
                discrimination
              </li>
              <li style={{ marginBottom: '12px' }}>
                <strong>Right to Information:</strong> Complete and accurate disclosure of all
                material information
              </li>
              <li style={{ marginBottom: '12px' }}>
                <strong>Right to Suitability:</strong> Investment advice suitable to your risk
                profile and financial goals
              </li>
              <li style={{ marginBottom: '12px' }}>
                <strong>Right to Privacy:</strong> Protection of your personal and financial
                information
              </li>
              <li style={{ marginBottom: '12px' }}>
                <strong>Right to Grievance Redressal:</strong> Access to fair and timely resolution
                of complaints
              </li>
            </ul>
            ...
            <ul style={{ paddingLeft: '20px', marginBottom: '20px' }}>
              ...
              <li style={{ marginBottom: '12px' }}>
                Provide complete and accurate information about your financial situation and risk
                appetite
              </li>
              <li style={{ marginBottom: '12px' }}>
        ...
        <div className="glass-effect" style={{ padding: '60px 40px', marginBottom: '40px' }}>
          ...
          <div style={{ color: '#CCCCCC', lineHeight: 1.8, fontSize: '16px' }}>
            ...
            <p style={{ marginBottom: '20px' }}>
              We are committed to addressing your concerns promptly and fairly. If you have any
              grievances regarding our services, please follow the process outlined below:
            </p>
            ...
            <p style={{ marginBottom: '20px' }}>
              If your concern is not resolved through initial contact, please submit a written
              complaint including:
            </p>
            <ul style={{ paddingLeft: '20px', marginBottom: '20px' }}>
            ...
            <p style={{ marginBottom: '20px' }}>
              If you are not satisfied with our resolution, you may escalate your complaint to the
            ...
            >
              <AlertCircle
                size={24}
                style={{ color: '#DAA520', flexShrink: 0, marginTop: '2px' }}
              />
              <div>
                <strong style={{ color: '#DAA520' }}>Important Note:</strong>
                <p style={{ margin: '8px 0 0 0' }}>
                  Please keep a copy of your complaint and all correspondence for your records. We
                  are committed to resolving all grievances in a fair, transparent, and timely
                  manner in accordance with regulatory guidelines.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="glass-effect" style={{ padding: '40px', marginBottom: '40px' }}>
          ...
          <div style={{ color: '#CCCCCC', lineHeight: 1.8, fontSize: '16px' }}>
            ...
            <p style={{ marginBottom: '10px' }}>
              <strong style={{ color: '#C0A062' }}>Validity:</strong> Perpetual (subject to
            ...
            >
              <p style={{ marginBottom: '0' }}>
                BM Wealth is an IRDAI Licensed Insurance Advisor (License No. 277925) and AMFI
                Registered Mutual Fund Distributor (ARN 90008). We follow SEBI guidelines for
                mutual fund distribution but are NOT SEBI-registered Investment Advisors. Our PMS
                and FD services are advisory in nature and provided through partnerships with
            ...
            <div className="sebi-disclaimer" style={{ marginTop: '0' }}>
              <strong>Disclaimer:</strong> Mutual fund investments are subject to market risks. Past
              performance is not indicative of future results. Please read all scheme-related
