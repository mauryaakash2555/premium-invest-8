      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '60px 20px' }}>
        ...
        <section style={{ marginBottom: '60px' }}>
          ...
          <p style={{ fontSize: '17px', lineHeight: '1.8', color: '#e5e5e5', marginBottom: '20px', textAlign: 'justify' }}>
            Portfolio management is the art and science of making investment decisions to achieve specific financial objectives while managing risk appropriately. At BM Wealth, our portfolio management services go beyond simple product selection – we create holistic wealth management strategies tailored to each client's unique financial situation, goals, risk tolerance, and life stage. Our AMFI registered advisors bring decades of combined experience serving Mumbai's affluent investors, from young professionals building their first crore to seasoned business owners managing multi-crore portfolios.
          </p>
          <p style={{ fontSize: '17px', lineHeight: '1.8', color: '#e5e5e5', marginBottom: '20px', textAlign: 'justify' }}>
        ...
        <section style={{
          ...
          <p style={{ fontSize: '14px', lineHeight: '1.7', color: '#e5e5e5', marginBottom: '12px' }}>
            <strong>Investment Disclaimer:</strong> Portfolio management involves market risks. Past performance does not guarantee future results. Asset allocation and diversification do not ensure profits or protect against losses. BM Wealth is an AMFI registered mutual fund distributor providing portfolio advisory services and mutual fund distribution. We are not SEBI-registered Investment Advisors or Portfolio Managers. For PMS, AIF, or sophisticated investment strategies, we provide referrals to appropriate SEBI-registered entities. All portfolio recommendations are made considering individual circumstances, goals, and risk profiles. Consult with our advisors for personalized guidance.
          </p>
        </section>
