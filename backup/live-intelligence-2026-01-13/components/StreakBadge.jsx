    ...
    <>
      ...
      <style jsx>{`
        ...
        .li-streak-main.hot {
          ...
          background: linear-gradient(180deg, rgba(255, 150, 50, 0.15) 0%, rgba(255, 100, 50, 0.08) 100%);
        }
        ...
        .li-streak-milestone {
          ...
          margin-top: 8px;
          padding: 12px 16px;
          background: linear-gradient(180deg, rgba(255, 200, 100, 0.18) 0%, rgba(255, 150, 50, 0.12) 100%);
