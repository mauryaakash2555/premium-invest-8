...
export function calculateTaxFY2526({
  ...
  const hraExempt = computeHraExemption({
    ...
    rentPaid,
    basicSalary: basic,
    // City is not collected in the UI. Default to non-metro (40%) to avoid overstating exemption.
    isMetro: false,
  });
  ...
  return {
    ...
    effectiveRate,
    assumptions: {
      hraMode: "min(actual, rent_minus_10pct_basic, 40pct_basic_non_metro)",
      hraCityAssumption: "non_metro_default",
