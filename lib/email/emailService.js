...
export const EmailService = {
  ...
  async sendHotLeadAlert({ to, lead }) {
    const dashboardUrl = String(process.env.PUBLIC_DASHBOARD_URL || 'https://www.bmwealth.co.in/admin-secret-akash');
  ...
  async sendDailySummary({ to, stats }) {
    ...
    const content = `
      ...
      <p><a class="button" href="${safeHtml(String(process.env.PUBLIC_DASHBOARD_URL || 'https://www.bmwealth.co.in/admin-secret-akash'))}">View Full Dashboard →</a></p>
    `;
