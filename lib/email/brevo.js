 ...
 */
export async function sendNewsletterWelcome({ email, name }) {
  const client = getClient();
...
<table width="600" cellpadding="0" cellspacing="0" style="background:#1a1a1a;border-radius:12px;overflow:hidden;max-width:100%;">
  ...
  <tr><td style="padding:36px 40px;">
    <p style="margin:0 0 18px;font-family:Arial,sans-serif;font-size:15px;line-height:1.7;color:#e0e0e0;">${greeting}</p>
