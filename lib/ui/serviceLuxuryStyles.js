export function getServiceLuxuryStyles({
  ...
  @keyframes svc-glowbreath {
    ...
    50% { box-shadow: 0 28px 80px rgba(0,0,0,0.55), 0 0 54px rgba(${rgb}, .14), inset 0 1px 0 rgba(255,255,255,0.08); }
  }
  @keyframes svc-sweep {
  ...
  @media (hover: none), (pointer: coarse) {
    ...
    .svc-cta:active {
      transform: translateY(-2px);
      border-color: rgba(${rgb}, .40) !important;
      box-shadow: 0 18px 55px rgba(${rgb}, .16);
    }

    .svc-card.svc-mobile-pulse {
      transform: translateY(-3px);
      border-color: rgba(${rgb}, .42);
