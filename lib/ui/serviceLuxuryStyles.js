export function getServiceLuxuryStyles({
  ...
  .svc-cta:hover {
    ...
    border-color: color-mix(in oklab, ${accent} 35%, transparent) !important;
    box-shadow: 0 14px 40px color-mix(in oklab, ${accent} 18%, transparent);
  }
  ...
  @media (hover: none), (pointer: coarse) {
    ...
    .svc-cta:active {
      transform: translateY(-2px);
      border-color: color-mix(in oklab, ${accent} 40%, transparent) !important;
      box-shadow: 0 18px 55px color-mix(in oklab, ${accent} 16%, transparent);
    }
