export const trackEvent = (eventName, params = {}) => {
  ...
  try {
    ...
    const allow = new Set([
      ...
      "calculator_email_sent",
      "calculator_email_failed",
      "lead_submit_free",
      "lead_submit_pay",
      "lead_captured",
      "premium_click",
      ...
      // Affiliate tracking (blog 11)
      "affiliate_idfc_click",
      "affiliate_au_click",
      "affiliate_indusind_click",

      // Execution routing (neutral)
      "execution_partners_view",
      "execution_options_click",
    ]);
