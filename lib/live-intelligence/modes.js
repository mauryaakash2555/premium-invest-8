...
export const MODES = {
  ...
  live_market: {
    ...
    accentColor: 'rgba(100, 180, 255, 1)',       // Laser blue (NOT green)
    accentColorDim: 'rgba(100, 180, 255, 0.25)',
    glowColor: 'rgba(100, 180, 255, 0.4)',
  },
  market_close: {
    ...
    accentColor: 'rgba(180, 140, 220, 1)',      // Purple (NOT gold)
    accentColorDim: 'rgba(180, 140, 220, 0.25)',
    glowColor: 'rgba(180, 140, 220, 0.4)',
  },
  evening_intel: {
    key: 'evening_intel',
