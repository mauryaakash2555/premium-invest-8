...
// ═══════════════════════════════════════════════════════════
// SAMPLE HEADLINES - COMPREHENSIVE MARKET INTELLIGENCE
// ═══════════════════════════════════════════════════════════

/**
 * Sample headlines covering all categories
...
export async function fetchHeadlinesFromAPI(category = null) {
  try {
    ...
    console.warn('Failed to fetch headlines from API, using fallback:', error);
    return getHeadlinesByCategory(category); // Fallback to local data
  }
}

/**
 * Get headlines filtered by category (synchronous, uses DUMMY_HEADLINES)
 * @param {string|null} category - Category key or null for all
 * @returns {Array} Filtered headlines
 */
export function getHeadlinesByCategory(category = null) {
  let headlines = DUMMY_HEADLINES;
  ...
  // Filter expired headlines
  return filterExpiredHeadlines(headlines);
}
