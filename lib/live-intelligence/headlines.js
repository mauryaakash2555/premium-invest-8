...
export async function fetchHeadlinesFromAPI(category = null) {
  try {
    ...
    console.error('Failed to fetch headlines from API, using curated content:', error);
    return getHeadlinesByCategory(category); // Use curated headlines
  }
}
...
export function getHeadlinesByCategory(category = null) {
  let headlines = CURATED_HEADLINES;
