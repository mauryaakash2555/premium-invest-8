...
export const PITCHES = {
  FREE_CONSULTATION: {
    message:
      "Based on your interest in investing, would you like to book a **free 15-minute consultation** with our AMFI-registered advisor?\n\n" +
      "They can provide personalized guidance based on your financial goals.",
  ...
  TRADING_PLATFORMS: {
    message:
      "Popular platforms our clients use for trading include:\n\n" +
