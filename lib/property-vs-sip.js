...
export function buildMumbaiPropertyVsSipPdfPayload({ lead, model }) {
  ...
  const complianceFooter = "BM Wealth | ARN 90008 | Educational mathematical projection.\n   Not investment advice.";
  ...
  return {
    meta: {
      ...
      footerLine: complianceFooter,
      filename: "Mumbai-Property-vs-SIP-Wealth-Gap-Report.pdf",
      emailSubject: "Your Mumbai Property vs SIP Wealth Gap Report is Ready",
      emailTitle: "Your Mumbai Property vs SIP Wealth Gap Report is Ready",
      emailSubtitle: "Your PDF is attached.",
      emailFooter: complianceFooter,
    ...
    blocks: {
      ...
      disclaimerText: "BM Wealth | ARN 90008 | Educational mathematical projection.\nNot investment advice.",
    },
  };
}
