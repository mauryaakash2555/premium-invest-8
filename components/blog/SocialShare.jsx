...
export default function SocialShare({ 
  ...
  const twitterText = tags.length > 0 
    ? `${title} ${tags.join(' ')}` 
    : title;
    ...
    <div className="my-12 py-8 border-y border-white/10">
      ...
      <div className="flex flex-wrap gap-3">
        ...
        >
          ...
          <span className="font-semibold hidden sm:inline">Telegram</span>
        </button>
        ...
        >
          ...
          <span className="font-semibold hidden sm:inline">Reddit</span>
        </button>
        ...
        >
          ...
          <span className="font-semibold hidden sm:inline">Email</span>
        </button>
        ...
        >
          {copied ? (
            <>
              ...
              <span className="font-semibold hidden sm:inline">Copied!</span>
            </>
          ) : (
            <>
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <span className="font-semibold hidden sm:inline">Copy Link</span>
            </>
          )}
        </button>
      </div>
