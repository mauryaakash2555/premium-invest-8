...
export default function SubmitStoryCTA() {
  return (
    <div className="my-12 border border-[color:var(--lux-foreground-10)] bg-[color:var(--lux-card)]/45 backdrop-blur-xl p-10 md:p-14">
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-10">
        <div>
          ...
          <div className="mt-6 text-3xl md:text-4xl font-medium text-[color:var(--lux-foreground-80)]">
