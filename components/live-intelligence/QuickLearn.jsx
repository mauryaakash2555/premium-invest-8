  ...
  return (
    <div className="ql-container">
      <div className="ql-header">
        <span className="ql-badge">30 sec learn</span>
        <span className="ql-category">{lesson.category}</span>
      </div>

      <div className="ql-topic">
        <span className="ql-emoji">{lesson.emoji}</span>
        <span className="ql-topic-text">{lesson.topic}</span>
      </div>

      <div className="ql-question">
        {lesson.question}
      </div>

      {!showAnswer ? (
        <button className="ql-reveal-btn" onClick={handleShowAnswer}>
        ...
        <div className="ql-answer-section">
          ...
          <div className="ql-fact">
            <span className="ql-fact-label">📌 Did you know?</span>
            {lesson.fact}
          </div>

          {!completed && (
            <button className="ql-complete-btn" onClick={handleComplete}>
              ✓ Got it!
            </button>
          )}

          {completed && (
            <div className="ql-completed">
      ...
      <style jsx>{`
        .ql-container {
          background: linear-gradient(180deg, rgba(20, 30, 45, 0.95) 0%, rgba(12, 18, 28, 0.98) 100%);
        ...
        .ql-badge {
          background: linear-gradient(135deg, rgba(100, 160, 255, 0.25) 0%, rgba(80, 140, 220, 0.2) 100%);
        ...
        .ql-complete-btn:hover {
          background: linear-gradient(135deg, rgba(100, 180, 140, 0.35) 0%, rgba(80, 160, 120, 0.35) 100%);
