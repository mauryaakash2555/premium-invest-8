  ...
  return (
    <div style={card}>
      <p style={{ margin: "0 0 12px 0", fontSize: 14, color: "#d0d0d0", lineHeight: 1.75 }}>
        A quick drift check between current and target allocation. This is a mechanical illustration, not investment advice.
      </p>
      ...
      >
        <div style={{ display: "flex", justifyContent: "space-between", gap: 12, flexWrap: "wrap" }}>
          ...
          <div style={{ fontSize: 13, color: "#e5e5e5" }}>
            {actionLabel}: <strong style={{ color: "#DAA520" }}>{formatINR(Math.abs(result.delta))}</strong>
          </div>
        </div>
      </div>
